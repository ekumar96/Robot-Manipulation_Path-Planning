...
class PyBulletSim:
    ...
    def move_tool(self, position, orientation, speed=0.03):
        ...
        # Here, we use PyBullet's inverse Kinematics function to calculate the joint angles neccessary 
        # to cause the end effector (grasper) to reach a given position and orientation
        target_joint_state = p.calculateInverseKinematics(self.robot_body_id, self.robot_end_effector_link_index, position, orientation, maxNumIterations = 100)
    ...
    def execute_grasp(self, grasp_position, grasp_angle):
        ...
        # Using several functions defined above, we can make the robot move to the object and grasp it
        self.open_gripper()
